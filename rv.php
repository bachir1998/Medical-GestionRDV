...
<html >
    ...
    <body>
		...
		if(isset($_GET['nomservices'])){    //On recupere l'url envoyer depuis tester.php
			...
			$requete='select * from services s join district d join personne p on s.idistrict=d.idistrict and s.idpersonnel=p.email where nomservices="'.$nomservices.'"';
			...
			echo "<div class='inf'>
					<span class='le'>Services</span> : <span class='per'>".$row['nomservices']."</span></br>
					<span class='le'>District</span><span class='per'> : ".$row['nomdistrict']."</span>
				  </div>
				  <div class='inf' id='adr'>
					<span class='le'>Médecin</span> : <span class='per'>".$row['prenom']. " ".$row['nom']."</span></br>
